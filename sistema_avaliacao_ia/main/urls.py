...
urlpatterns = [
    ...
    path("competicoes/<int:compid>/reports/", views.comp_report_view, name="comp-report"),
    path("competicoes/<int:compid>/delete/", views.delete_competition_view, name="delete-competition"),
