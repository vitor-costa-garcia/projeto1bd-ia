...
class CompeticaoPred(models.Model):
    id = models.IntegerField(primary_key=True)
    id_organizador = models.ForeignKey(Organizador, primary_key=True)
    ...
    cnpj_patrocinador = models.ForeignKey(Patrocinador)
    premiacao = models.FloatField(null=True)

class CompeticaoPredRegras(models.Model):
    id_competicao = models.ForeignKey(CompeticaoPred, primary_key=True)
    id_org_competicao = models.ForeignKey(Organizador, primary_key=True)
...
class ComposicaoEquipeCompeticaoPred(models.Model):
    id_equipe = models.ForeignKey(EquipeCompeticaoPred, primary_key=True)
    id_competicao = models.ForeignKey(CompeticaoPred, primary_key=True)
    id_org_competicao = models.ForeignKey(Organizador, primary_key=True)
    id_competidor = models.ForeignKey(Usuario, primary_key=True)
...
class CompeticaoSimulRegras(models.Model):
    id_competicao = models.ForeignKey(CompeticaoSimul, primary_key=True)
    id_org_competicao = models.ForeignKey(Organizador, primary_key=True)
    n_ordem = models.IntegerField()
    regra = models.CharField(max_length=200)
...
class ComposicaoEquipeCompeticaoSimul(models.Model):
    id_equipe = models.ForeignKey(EquipeCompeticaoSimul, primary_key=True)
    id_competicao = models.ForeignKey(CompeticaoSimul, primary_key=True)
    id_org_competicao = models.ForeignKey(Organizador, primary_key=True)
    id_competidor = models.ForeignKey(Usuario, primary_key=True)
    data_hora_inicio = models.DateTimeField(primary_key=True)
