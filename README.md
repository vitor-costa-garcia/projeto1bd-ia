...
COMPETICAO_PRED = {PK ID_COMPETICAO, PK FK ID_ORG_COMPETICAO, FLG_OFICIAL, TITULO, DESCRICAO, DIFICULDADE, DATA_CRIACAO, DATA_INICIO, DATA_FIM, METRICA_DESEMPENHO, DATASET_TT, DATASET_SUBMISSAO, DATASET_GABARITO, PREMIACAO}
COMPETICAO_SIMUL = {PK ID_COMPETICAO, PK FK ID_ORG_COMPETICAO, FLG_OFICIAL, TITULO, DESCRICAO, DIFICULDADE, DATA_CRIACAO, DATA_INICIO, DATA_FIM, METRICA_DESEMPENHO, AMBIENTE, PREMIACAO}
